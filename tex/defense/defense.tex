...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Regeln die häufig ausgelöst wurden, sind weniger relevant.
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Regeln die ein einzigartiges Auslösemuster sind relevanter.
  \end{itemize}
  \begin{greyblock}{Berechnungsfunktion}
    \scriptsize{
      \[
      ...
      \]
      \[
      0 \leq Jaccard(A, B) \leq 1, \quad A, B \in \mathbb{B}^n, \quad n = | \text{Specifikationen} |
      \]
    }
  \end{greyblock}
\end{frame}  
