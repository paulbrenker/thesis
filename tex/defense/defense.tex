...
\begin{frame}
  ...
  \begin{greyblock}{Berechnungsfunktion}
    \scriptsize{
      ...
      \]
      \[
        summe(r) = \sum_{i=1}^{n}vorkommen(r, i)
      \]
      \[
        vorkommen(r, s) = 
        \begin{cases} 
      ...
      \]
      \[
       s \in S, \text{ wobei $S$ die Menge aller Spezifikationen aus dem OpenAPI Directory ist.}
      \]
      \[
        n = \vert S \vert
      \]
...
\begin{frame}
  ...
  \begin{greyblock}{Berechnungsfunktion}
    \scriptsize{
      ...
      \]
      \[
      0 \leq Jaccard(A, B) \leq 1, \quad A, B \in \mathbb{B}^n, \quad n = \vert \text{Spezifikationen} \vert
      \]
    }
  \end{greyblock}
\end{frame}  
...
\begin{frame}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{images/priodistrhist.png}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Subjektive Einschätzungen der Relevanz von Linterregeln sind weiterhin wichtig und lassen sich durch Methode nicht ersetzen.
  \end{itemize}
\end{frame}