...
\begin{frame}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{images/totalspecthrownbarplot.png}
...
\begin{frame}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\linewidth]{images/priodistrhist.png}
...
\begin{frame}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\linewidth]{images/clusterprioscatter.png}
