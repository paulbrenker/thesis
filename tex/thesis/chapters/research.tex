...
Um die Funktion von Software in verteilten Systemen nutzbar zu machen sind standardisierte Schnittstellenspezifikationen hilfreich u.a. \parencite{steen_distributed_2023}. Schnittstellen sollten außerdem \glqq einfach zu erlernen und benutzen sein\grqq{} \parencite{starke_effektive_2020}. Zudem sollen Anwendungsschnittstellen sogenannte \acf{API} bestimmte Qualitätsgarantien an die Software geben darunter Durchsatz, Performance und Verfügbarkeit \parencite{starke_effektive_2020}. 
