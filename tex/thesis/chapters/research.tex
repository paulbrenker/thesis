...
Massé stellt im Buch \textit{REST API Design Rulebook} \parencite{masse_rest_2011} 82 Regeln auf, die für ein Design von REST Prinzipien konformen APIs eingehalten werden sollen. 
