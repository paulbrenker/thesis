...
\begin{longtable}{lll}
  ...
  info-license & no-eval-in-markdown & operation-description\\
  license-url & no-script-tags-in-markdown & operation-operationId\\
...
Die Verteilung der invertierten Häufigkeit der geworfenen Linterfehler ist für alle Regeln, die mindestens einmal ausgelöst werden, in Abbildung \ref{fig:boxplotcleanmultitrigger} gezeigt. Da der Median für diese Linterregeln gleich 0 ist und so Verteilungen nur schwer sichbar sind, werden in dieser Visualisierung Spezifikationen, die nicht gegen eine Regel verstoßen, herausgefiltert.
...
\begin{figure}[htbp]
  ...
  \caption{Dendrogram der Jaccard Ähnlichkeit der Regeln.}
