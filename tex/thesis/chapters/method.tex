...
Diese Interaktionen werden in den folgenden Unterkaptieln gezeigt.
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{UC-2} beschreibt Invertierung von Linterfehlern}
  \label{fig:UC2}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{UC-3} beschreibt Analyse der ermittelten Daten}
  \label{fig:UC3}
\end{figure}
