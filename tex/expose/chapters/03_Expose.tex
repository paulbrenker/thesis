...
In Abbildung \ref{fig:Kontextsicht} ist beispielhaft eine Kontextsicht auf das zu entwickelnde Softwaretool abgebildet. Die Kontextabgrenzung zeigt, wie das System mit bestehenden Systemen und Paketen interagiert \parencite{starke_effektive_2020}.

\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{img/kontextsicht.png}
